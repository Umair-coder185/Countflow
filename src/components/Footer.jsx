          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex gap-3">
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="inline-flex p-2 rounded-lg bg-white/5 hover:bg-white/10 transition">
                  <Twitter size={18} />
                </a>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="inline-flex p-2 rounded-lg bg-white/5 hover:bg-white/10 transition">
                  <Linkedin size={18} />
                </a>
